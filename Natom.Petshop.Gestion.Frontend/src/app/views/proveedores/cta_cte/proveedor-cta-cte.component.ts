...
@Component({
  selector: 'app-proveedor-cta-cte',
  styleUrls: ['./proveedor-cta-cte.component.css'],
  templateUrl: './proveedor-cta-cte.component.html'
})
export class ProveedorCuentaCorrienteComponent implements OnInit {
  ...
  onNuevoClick() {
    this.routerService.navigate(['/proveedores/cta_cte/' + this.proveedorId + '/new']);
  }

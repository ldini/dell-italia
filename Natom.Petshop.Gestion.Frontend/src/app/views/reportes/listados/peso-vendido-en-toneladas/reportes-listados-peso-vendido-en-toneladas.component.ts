...
@Component({
  selector: 'app-reportes-listados-peso-vendido-en-toneladas',
  styleUrls: ['./reportes-listados-peso-vendido-en-toneladas.component.css'],
  templateUrl: './reportes-listados-peso-vendido-en-toneladas.component.html'
})

export class ReportesListadosPesoVendidoEnToneladasComponent implements OnInit {
  ...
  onConsultar() {
    ...
    this.apiService.OpenNewTab("reportes/listados/peso-vendido-en-toneladas");
  }

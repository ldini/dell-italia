...
@Component({
  selector: 'app-total-ventas-por-lista-de-precios',
  styleUrls: ['./total-ventas-por-lista-de-precios.component.css'],
  templateUrl: './total-ventas-por-lista-de-precios.component.html'
})

export class TotalVentasPorListaDePreciosComponent implements OnInit {
  ...
  onConsultar() {
    ...
    this.apiService.OpenNewTab("reportes/estadistica/total-ventas-por-lista-de-precios?desde=" + encodeURIComponent(this.filtroFechaDesdeValue));
  }
}

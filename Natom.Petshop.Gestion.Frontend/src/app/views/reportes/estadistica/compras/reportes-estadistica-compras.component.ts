...
@Component({
  selector: 'app-reportes-estadistica-compras',
  styleUrls: ['./reportes-estadistica-compras.component.css'],
  templateUrl: './reportes-estadistica-compras.component.html'
})

export class ReportesEstadisticaComprasComponent implements OnInit {
  ...
  onConsultar() {
    ...
    this.apiService.OpenNewTab("reportes/estadistica/compras?desde=" + encodeURIComponent(this.filtroFechaDesdeValue) + "&hasta=" + encodeURIComponent(this.filtroFechaHastaValue));
  }
}

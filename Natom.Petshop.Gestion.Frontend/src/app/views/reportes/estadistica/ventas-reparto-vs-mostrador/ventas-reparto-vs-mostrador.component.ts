...
@Component({
  selector: 'app-ventas-reparto-vs-mostrador',
  styleUrls: ['./ventas-reparto-vs-mostrador.component.css'],
  templateUrl: './ventas-reparto-vs-mostrador.component.html'
})

export class VentasRepartoVsMostradorComponent implements OnInit {
  ...
  onConsultar() {
    ...
    this.apiService.OpenNewTab("reportes/estadistica/ventas-reparto-vs-mostrador?desde=" + encodeURIComponent(this.filtroFechaDesdeValue));
  }
}

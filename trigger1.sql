CREATE TRIGGER [dbo].[trg_ActualizarMoviemientoCierre]
...
BEGIN
    ...
    WHEN NOT MATCHED THEN
        INSERT ([Mes], [Ano], [Registradora1], [Registradora2], [FacturaA], [Vales], [Gastos],[Compras], [ComprasA], [ComprasB], [Diferencias], [Efectivo], [Tarjeta/M.Pago], [TurnoM], [TurnoN], [Total], [Cierre_Caja])
        VALUES (i.[Mes], i.[Ano], i.[Registradora1], i.[Registradora2], i.[FacturaA], i.[Vales], i.[Gastos],i.[Compras], i.[ComprasA], i.[ComprasB], i.[Diferencias], i.[Efectivo], i.[Tarjeta/M.Pago], i.[TurnoM], i.[TurnoN],i.[TurnoM]+i.[TurnoN], NULL);
